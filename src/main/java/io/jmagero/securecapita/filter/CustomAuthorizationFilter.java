...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    @Override// Help us to write cleaner code. This method is executed first
    ...
    private String getToken(HttpServletRequest request) {
        return ofNullable(request.getHeader(AUTHORIZATION))
                ...
                .map( token -> token.replace(TOKEN_PREFIX, EMPTY)) //Can use substring
                .get();

        //since shouldNotFilter checks for null
