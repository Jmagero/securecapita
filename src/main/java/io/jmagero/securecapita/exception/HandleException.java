package io.jmagero.securecapita.exception;
...
public class HandleException extends ResponseEntityExceptionHandler  implements ErrorController {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception exception, Object body, HttpHeaders headers, HttpStatusCode statusCode, WebRequest request) {
        ...
        return new ResponseEntity<>(
                ...
                .developerMessage(exception.getMessage()) //Never do this in a real project
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException exception, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
                        .reason(fieldMessage)
                        .developerMessage(exception.getMessage()) //Never do this is in a real project
    ...
    public ResponseEntity<HttpResponse> apiException(ApiException exception) {
        ...
        return new ResponseEntity<>(
                HttpResponse.builder()
                        .timeStamp(now().toString())
                        .reason(exception.getMessage())
                        .developerMessage(exception.getMessage()) //Never do exception.getMessage() this is in a real project
                        .status(BAD_REQUEST)
                        .statusCode(BAD_REQUEST.value())
                        .build(), BAD_REQUEST);
    }
